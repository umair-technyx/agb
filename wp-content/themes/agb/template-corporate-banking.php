								            ...
								            <div class="content-box">
								                ...
								                <div class="content-box-wrapper <?php echo $style_class ?>">
								                    ...
								                    <div class="content-box-content">
								                        ...
								                        <a href="<?php echo $button_url ?>" class="btn btn-primary"><?php echo $button_text ?> <img src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/btn-arrow.svg" alt=">" class="js-tosvg tosvg"></a>
