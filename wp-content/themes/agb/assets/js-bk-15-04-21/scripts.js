...
//                     }
//                 },
//                 errorPlacement: function (errorText, element) {
//                     console.log(errorText);
//                     if (errorText != "") {
//                         $('.error-txt').html($('.error-txt').data('errorMsg'));
//                     } else{
//                     }
//                 },
...
//     }
// }
// $.validator.addMethod('validEmail', value => /^([A-Za-z0-9_\-\.\%\$\&\'\(\)\*\+/])+\@([a-z])+\.([a-z]{2,4})$/gi.test(value));